...
const SocialCardSkeleton = () => {
    return (
        <div className="border-2 border-zinc-800 flex items-center p-5 shadow rounded-xl animate-pulse">
                    ...
                    socials.items.map((s) => {
                        ...
                        return (
                            <a
                                ...
                                target="_blank"
                                rel="noreferrer"
                                className="group hover:bg-[#1a1a1a] transition-all flex items-center p-5 shadow rounded-xl"
                            >
                                ...
                                <div className="flex-1">
                                    <h3 className="text-white font-medium mb-1 text-xl flex justify-between items-center">
                                        <span>{s.name}</span>
                                        <FaArrowRight className="text-zinc-300 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                                    </h3>
